...
Grid2Options:RegisterStatusOptions("afk", "misc", nil, {titleIcon = "Interface\\ICONS\\Spell_nature_sleep"})
Grid2Options:RegisterStatusOptions("voice", "misc", nil, {titleIcon = "Interface\\COMMON\\VOICECHAT-SPEAKER"})
...
Grid2Options:RegisterStatusOptions("resurrection", "combat", nil, {
	...
	width = "full",
	titleIcon = "Interface\\Icons\\Spell_Holy_Resurrection"
})