...
L["Adjust the size of the icons, select Zero to use the theme icon size."] = true
...
L["Anchor"] = true
L["Select how to anchor the background bar."] = true
L["Add Bar"] = true
...
L["Create Buff"] = true
L["Create Default Buffs"] = true
L["Create Default Buffs for %s."] = true
